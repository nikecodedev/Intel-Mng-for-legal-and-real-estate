...
VALUES (
  ...
  '{"stage": {"eq": "F4"}}',
  'create_task',
  '{"task_type": "create_real_estate_asset", "status": "EM_REGULARIZACAO", "copy_fields": ["title", "address", "description", "estimated_value"], "reason": "Arrematação homologada (F4) — ativo imobiliário criado automaticamente para regularização."}',
  true,
  NOW(),
  NOW()
);
